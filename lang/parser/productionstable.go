...
var productionsTable = ProdTab{
	...
	ProdTabEntry{
		String: `SelectQuery : SelectClause DatasetClause WhereClause	<<  >>`,
		Id:         "SelectQuery",
		NTType:     2,
		Index:      2,
		NumSymbols: 3,
	...
	ProdTabEntry{
		String: `SelectQuery : SelectClause WhereClause	<< ast.NewQuery(X[0], X[1]) >>`,
		Id:         "SelectQuery",
		NTType:     2,
		Index:      3,
		NumSymbols: 2,
	...
	ProdTabEntry{
		String: `DatasetClause : "FROM" string	<<  >>`,
		Id:         "DatasetClause",
		NTType:     6,
		Index:      9,
		NumSymbols: 2,
